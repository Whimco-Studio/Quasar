...
function generateProjectJson() {
  ...
  ensure(tree, ["ServerScriptService", "TS"], { $path: "out/common/server" });
  ensure(tree, ["ReplicatedStorage", "TS"], { $path: "out/common/shared" });
  ensure(tree, ["ReplicatedStorage", "typescript-types"], { $path: "out/types" });
  ensure(tree, ["StarterPlayer", "StarterPlayerScripts", "TS"], { $path: "out/common/client" });
